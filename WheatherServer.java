...
public class WeatherServer {
    private static final String API_KEY = "8e0b2e120250866aac20c1d580e3da29"; // OpenWeatherMap API key
            ...
            if ("POST".equals(exchange.getRequestMethod()) && "/weather".equals(exchange.getRequestURI().getPath())) {
                try {
                    ...
                    if (responseCode == 200) {
                        ...
                        jsonResponse.put("Temperature", Math.round(temperature * 100.0) / 100.0);
